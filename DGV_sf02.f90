...
real (DP), parameter, private :: T1=0.0428571429_DP  ! dimensionless temperature  -- ratio to T_{\infyt}, 
real (DP), parameter, private :: d1=1.6094213293_DP*2.0_DP  ! dimensionless density == ration to initial number density
real (DP), parameter, private :: u1=1.2283828258_DP ! dimensionless bulk velocity  -- ratio to C_{\infty}
real (DP), parameter, private :: v1=0.0_DP ! v1=?
real (DP), parameter, private :: w1=0.0_DP ! w1=?

! condtions after the shock wave 
real (DP), parameter, private :: T2=0.6031580199_DP   !  dimensionless temperature  -- ratio to T_{\infyt}, 
real (DP), parameter, private :: d2=6.0108772843_DP*2.0_DP   !  dimensionless density == ration to initial number density
real (DP), parameter, private :: u2=0.3289013189_DP ! dimensionless bulk velocity  -- ratio to C_{\infty}
